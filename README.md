...
| Procedure Check in! | 'p' to proceed, 'c' to change - re-plays previous feature | Inputs: '', 'g', '4', 'p'   | Loops until validated ('p') with appropriate error messages, proceeds to next feature   | <img src="docs/images/thumbs-up.jpg"> |
| Exit Check in   | Loop until Validated? Existing Budget Retrieval? | Inputs: 'w', '8', '' | Loops until validated ('') with appropriate error messages, proceeds to retrieve existing budget from Month sheet  | <img src="docs/images/thumbs-up.jpg"> |
